package com.sevencailongzhu.art.ecommerce.config;
...
@Configuration
@MapperScan("com.sevencailongzhu.art.ecommerce.dao")
...
public class MybatisConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        sessionFactory.setMapperLocations(new Resource[]{new ClassPathResource("mybatis/generated/UserMapper.xml")});
